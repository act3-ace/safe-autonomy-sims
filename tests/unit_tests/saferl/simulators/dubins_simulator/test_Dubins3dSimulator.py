...
# Define test assay
test_cases_dir = os.path.join(os.path.split(__file__)[0], "../../../../test_cases/simulators/rejoin/Dubins3dSimulator_test_cases/")
...
def fixture_expected_sim_platforms(expected_platform_configs):
    ...
    platforms = {
        expected_platform_configs[0]["platform_name"]: Dubins3dPlatformFactory(**(expected_platform_configs[0])),
        expected_platform_configs[1]["platform_name"]: Dubins3dPlatformFactory(**(expected_platform_configs[1]))
    }
    return platforms
