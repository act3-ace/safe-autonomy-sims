...
from saferl.backend.dubins.entities import Dubins3dAircraft
...
# Define test assay
test_cases_file_path = os.path.join(os.path.split(__file__)[0], "../../test_cases/backend/Dubins3dAircraft_test_cases.yaml")
