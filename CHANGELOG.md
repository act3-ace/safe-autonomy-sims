# [4.0.0](https://git.act3-ace.com/rta/safe-autonomy-stack/safe-autonomy-sims/compare/v3.2.11...v4.0.0) (2024-04-08)
...
* **dependencies:** update CoRL to publicly released 3.14.13 ([9f07324](https://git.act3-ace.com/rta/safe-autonomy-stack/safe-autonomy-sims/commit/9f073247bbbe1d677d3f5016c98addc19ca55319))

## [3.2.8](https://git.act3-ace.com/rta/safe-autonomy-stack/safe-autonomy-sims/compare/v3.2.7...v3.2.8) (2024-03-21)


### Bug Fixes

* **dependencies:** upgrade to CoRL 3.14.7 ([6345f0e](https://git.act3-ace.com/rta/safe-autonomy-stack/safe-autonomy-sims/commit/6345f0eefe9202effcd6b69ac98acd11f9afcab0))
...
* **dependencies:** update CoRL to 3.6.3 (public release candidate) ([6a17701](https://git.act3-ace.com/rta/safe-autonomy-stack/safe-autonomy-sims/commit/6a177011533ec155fd0263fd613b47074cc027f6))
...
* Move horizon to env config ([1b26a86](https://git.act3-ace.com/rta/safe-autonomy-stack/safe-autonomy-sims/commit/1b26a86201eb735ff541b001197e5f77222d1d8e))
...
* Rejection Sampling ([5854581](https://git.act3-ace.com/rta/safe-autonomy-stack/safe-autonomy-sims/commit/5854581d9db0e47059b498194109a73f2e163af9))
