...
2. To create the entity containing the new Dynamics, extend safe-autonomy-dynamics.base_models.BaseEntity and pass an instance of the new Dynamics class to super() constructor inside the Entity's **init**() method. See safe-autonomy-dynamics.cwh.point_model.CWHSpacecraft for an example.
