...
class serialize_cwh3d(PlatformSerializer):
    """
    This is a implementation of the abstract class PlatformSerializer.
    This provides functionality for serializing a cwh3d platform.
    """
    ...
    def serialize(self, platform):
        ...
        ----------
        platform
            The incoming 3d inspection platform object that needs to be serialized
